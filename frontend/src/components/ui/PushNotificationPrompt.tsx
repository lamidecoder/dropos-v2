      ...
      {show && (
        <motion.div
          ...
          style={{
            ...
            background: T.card, border: "1px solid rgba(107,53,232,0.3)",
          ...
          <div style={{ padding: "16px 16px 0", display: "flex", alignItems: "flex-start", gap: 12 }}>
            ...
            <button onClick={dismiss} style={{ color: T.faint, background: "none", border: "none", cursor: "pointer" }}>
              <X size={14} />
            </button>
          </div>
          <div style={{ display: "flex", gap: 8, padding: 12 }}>
            <button onClick={dismiss}
              style={{ flex: 1, padding: "8px", borderRadius: 10, border: "1px solid rgba(255,255,255,0.1)", background: "transparent", color: T.muted, fontSize: 12, cursor: "pointer" }}>
              Not now
            </button>
