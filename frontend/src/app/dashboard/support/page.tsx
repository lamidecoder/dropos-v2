...
import { LifeBuoy, Zap, ChevronRight } from "lucide-react";
    ...
    <div style={{ maxWidth: 1400, margin: "0 auto" }}>
      ...
      >
        ...
        <p style={{ fontSize: 13, color: t.muted, maxWidth: 380, lineHeight: 1.6, marginBottom: 28 }}>
          Get help from the DropOS team. KIRO can help you get started with this right now.
        </p>
