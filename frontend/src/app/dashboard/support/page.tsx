...
const FAQS = [
  { q:"How do I connect Paystack?",    a:"Go to Settings → Payments and follow the Paystack setup steps. It takes about 2 minutes and your store will be ready to accept payments immediately." },
  ...
  { q:"Why is KIRO not responding?",   a:"KIRO may be temporarily unavailable. Please wait a moment and try again. If the issue continues, contact our support team." },
