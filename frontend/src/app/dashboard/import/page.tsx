    ...
    <div style={{ maxWidth: 1400, margin: "0 auto" }}>
      <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 13, color: t.muted, marginTop: 4 }}>
          Import products from suppliers and URLs
        </p>
      </motion.div>
      ...
      >
        ...
        <p style={{ fontSize: 13, color: t.muted, maxWidth: 380, lineHeight: 1.6, marginBottom: 28 }}>
          Import products from suppliers and URLs. KIRO can help you get started with this right now.
        </p>
