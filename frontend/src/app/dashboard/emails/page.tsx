"use client";
﻿"use client";
// Path: frontend/src/app/dashboard/emails/page.tsx
import { motion } from "framer-motion";
import { useTheme } from "../../../components/layout/DashboardLayout";
import { Mail, Zap, ChevronRight } from "lucide-react";
    ...
    <div style={{ maxWidth: 1400, margin: "0 auto" }}>
      ...
      >
        ...
        <p style={{ fontSize: 13, color: t.muted, maxWidth: 380, lineHeight: 1.6, marginBottom: 28 }}>
          Send marketing emails to your customers. KIRO can help you get started with this right now.
        </p>
