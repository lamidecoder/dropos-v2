"use client";
﻿"use client";
// Path: frontend/src/app/dashboard/shipping/page.tsx
    ...
    <div style={{ maxWidth: 1400, margin: "0 auto" }}>
      ...
      >
        <div style={{
          ...
          marginBottom: 20,
          background: "#6B35E812",
          border: "1px solid #6B35E825"
        }}>
          <Truck size={28} color="#6B35E8" />
        </div>
        ...
        <p style={{ fontSize: 13, color: t.muted, maxWidth: 380, lineHeight: 1.6, marginBottom: 28 }}>
          Configure shipping zones and rates. KIRO can help you get started with this right now.
        </p>
