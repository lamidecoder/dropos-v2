...
export default function AboutPage() {
  return (
    <div style={{ background:"#F4F2FB", color:"#fff", fontFamily:"'Plus Jakarta Sans', system-ui, sans-serif", minHeight:"100vh" }}>
      ...
      {/* Mission */}
      <div className="max-w-5xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center" style={{ borderTop:"1px solid rgba(107,53,232,0.07)" }}>
        <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            <div key={v.label} className="p-4 rounded-2xl" style={{ background:"rgba(107,53,232,0.03)", border:"1px solid rgba(107,53,232,0.07)" }}>
              ...
              <p className="text-xs leading-relaxed" style={{ color:"rgba(19,13,46,0.5)" }}>{v.desc}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Team */}
      <div className="max-w-4xl mx-auto px-6 py-16" style={{ borderTop:"1px solid rgba(107,53,232,0.07)" }}>
        ...
        <div className="grid sm:grid-cols-2 gap-5 max-w-2xl mx-auto">
          {[
            ...
            <div key={m.name} className="p-6 rounded-2xl" style={{ background:"rgba(107,53,232,0.03)", border:"1px solid rgba(107,53,232,0.08)" }}>
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color:"rgba(19,13,46,0.5)" }}>{m.role}</p>
                </div>
              </div>
              <p className="text-sm leading-relaxed mb-4" style={{ color:"rgba(19,13,46,0.5)" }}>{m.bio}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16" style={{ borderTop:"1px solid rgba(107,53,232,0.07)" }}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {["Next.js 14","TypeScript","KIRO AI Engine","Tailwind CSS","Prisma","PostgreSQL","Paystack","Fal.ai","Cloudinary","Resend","Render","Vercel"].map(tech => (
            <div key={tech} className="px-4 py-3 rounded-xl text-center text-sm font-medium" style={{ background:"rgba(107,53,232,0.03)", border:"1px solid rgba(107,53,232,0.07)", color:"rgba(19,13,46,0.5)" }}>
              {tech}
            </div>
          ))}
        </div>
      ...
      {/* Numbers */}
      <div className="max-w-5xl mx-auto px-6 py-16" style={{ borderTop:"1px solid rgba(107,53,232,0.07)" }}>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
          {[
            ...
            <div key={s.label}>
              ...
              <p className="text-sm" style={{ color:"rgba(19,13,46,0.5)" }}>{s.label}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="text-center px-6 py-20" style={{ borderTop:"1px solid rgba(107,53,232,0.07)" }}>
        ...
        <p className="text-base mb-8" style={{ color:"rgba(19,13,46,0.5)" }}>Start free. No credit card. Your store live in 60 seconds.</p>
