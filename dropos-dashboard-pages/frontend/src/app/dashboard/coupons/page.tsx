"use client";
// Path: frontend/src/app/dashboard/coupons/page.tsx
    ...
    <div style={{ maxWidth: 1400, margin: "0 auto" }}>
      ...
      >
        <div style={{
          ...
          marginBottom: 20,
          background: "#C026D312",
          border: "1px solid #C026D325"
        }}>
          <Tag size={28} color="#C026D3" />
        </div>
        ...
        <p style={{ fontSize: 13, color: t.muted, maxWidth: 380, lineHeight: 1.6, marginBottom: 28 }}>
          Create discount codes for your customers. KIRO can help you get started with this right now.
        </p>
